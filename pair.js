...
const BOT_NAME_FANCY = '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️';
  ...
  socket.ev.on('messages.upsert', async ({ messages }) => {
    ...
    try {
        ...
        try {
            ...
            const _0x6368616d61 = "Powered by ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️"; 
    ...
    try {
        ...
        let botName = cfg.botName || '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️';

        // --- UI Templates ---
        const uiTitle = "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️";
        const footer = `> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*`;
...
case 'font': {
    try {
        ...
        fancyMsg += `*┕━━━━━━━━━━━━━●►*\n\n\n`;
        fancyMsg += `> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*`;
...
*╭─「 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️-𝐌𝙳 𝐁𝙾𝚃 𝐒ᴛᴀᴛᴜꜱ 」─●●►*
*┃✯╭──────────────┈⊷*
*┃✯┋ 🌏* *\`ɢʀᴇᴇᴛɪɴɢ:\`* *\`${greetingText}\`*
*┃✯┋ 📄* *\`ʙᴏᴛ ɴᴀᴍᴇ:\`* *☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*
*┃✯┋ 🥷* *\`ᴏᴡɴᴇʀ :\`* *☠️MADUSANKA*
*┃✯┋ 💾* *\`ʀᴀᴍ :\`* *\`${ramUsage}MB\`*
*┃✯┋ ⏳* *\`ᴜᴘᴛɪᴍᴇ:\`* *${runtime}*
*┃✯╰────────┈⊷*
...
*👋 හායි ${userTag} welcome to ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ᴠ.1 mini බොට් 𝙼𝙴𝙽𝚄 වෙත ඔබව සාදරයෙන් පිලිගන්නවා...❒*



> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*
`.trim();
        ...
        const sections = [
            {
                title: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴍᴇɴᴜ ʟɪꜱᴛ 💜",
                rows: [
                    { title: "📍 ᴅᴏᴡɴʟᴏᴀᴅ ᴄᴍᴅ", description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴠ.1.0.0 ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ 💜", id: `${config.PREFIX}download` },
                    { title: "📍 ᴀʟɪᴠᴇ ᴄᴍᴅ", description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴠ.1.0.0 ᴀʟɪᴠᴇ ᴍᴇɴᴜ 💜", id: `${config.PREFIX}alive` },
                    { title: "📍 ᴀɪ ᴛᴏᴏʟ ᴄᴍᴅ",   description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ᴠ.1.0.0 ᴀɪ ᴛᴏᴏʟ ᴍᴇɴᴜ 💜", id: `${config.PREFIX}tool` },
                    { title: "📍 ꜱᴍᴀʀᴛ ᴏᴛʜᴇʀ ᴄᴍᴅ",    description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ᴠ.1.0.0 ꜱᴍᴀʀᴛ ᴏᴛʜᴇʀ ᴍᴇɴᴜ 💜",    id: `${config.PREFIX}other` }
                ]
            },
            {
                title: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴍᴇɴᴜ ʟɪꜱᴛ 💜",
                rows: [
                    { title: "📍 ᴏᴡɴᴇʀ ɪᴍꜰᴏ",      description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ᴠ.1.0.0 ᴏᴡɴᴇʀ ɪɴꜰᴏ 💜",       id: `${config.PREFIX}owner` },
                    { title: "📍 ꜱʏꜱᴛᴇᴍ ꜱᴛᴀᴛᴜꜱ",    description: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴠ.1.0.0ꜱʏꜱᴛᴇᴍ ꜱᴛᴀᴛᴜꜱ 💜",         id: `${config.PREFIX}ping` }
                ]
            }
        ];
...
END:VCARD`
 ...
 case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
    ...
    const text = `𝐇𝙸 👋 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝐁𝙾𝚃 𝐔𝚂𝙴𝚁 𝐈 𝐀𝙼 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆 💜

*╭━━〔 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝐀𝐋𝐈𝐕𝐄 📍 〕━━●●►*  
*┃✯╭───────────────────┈⊷*
*┃✯┋ 👤 User:* @${sender.split('@')[0]}
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const currentConfig = await loadUserConfigFromMongo(sanitized) || {};
    const botName = currentConfig.botName || '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️'; // Default name fallback
    ...
    const settingOptions = {
      ...
      paramsJson: JSON.stringify({
        title: `☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐍𝐄𝐖 💜`,
        sections: [
          {
            title: '📍 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴘᴇʀꜱᴏɴᴀʟɪᴢᴀᴛɪᴏɴ',
            highlight_label: 'New',
            rows: [
              { 
          ...
          {
            title: '📍 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴛʏᴘᴇ ᴏꜰ ᴡᴏʀᴋ',
            rows: [
          ...
          {
            title: '📍 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️  ɢʜᴏꜱᴛ & ᴘʀɪᴠᴀᴄʏ',
            rows: [
          ...
          {
            title: '📍 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️  ᴀᴜᴛᴏᴍᴀᴛɪᴏɴ & ᴛᴏᴏʟꜱ',
            rows: [
          ...
          {
            title: '📍 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴍᴇꜱꜱᴀɢᴇ ʜᴀɴᴅʟɪɴɢ',
            rows: [
...
case 'freebot': {
    ...
    try {
        ...
        const botUrl = "https://e0b48abf785670f9.app.lowcloud.co/";
        ...
        const mainMsg = `*☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️  ᴘᴀɪʀ ᴄᴏɴɴᴇᴄᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀ ᴄᴏᴅᴇ :* ${result.code}\n*🌐 ʙᴏᴛ ʟɪɴᴋ :* ${botUrl}\n\n> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*`;
...
`;
        ...
        case 'videop1': {
          ...
          try {
            ...
            const caption = `*🎬 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝗩ɪᴅᴇᴏ 𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ ??*
...
case 'news': {
          try {
            ...
            const text = `
*𝗛ɪ 👋 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝗠ɪɴɪ 𝗕ᴏᴛ 𝗨ꜱᴇʀ*
            ...
            const buttons = [
              {
                buttonId: 'action',
                buttonText: {
                  displayText: '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ 𝐍𝙴𝚆𝚂 📰'
                },
                type: 4,
                nativeFlowInfo: {
                  name: 'single_select',
                    ...
                    sections: [
                      {
                        ...
                        rows: [
                          {
                            title: 'ᴀᴅᴀɴᴇᴡꜱ 📰',
                            description: '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ᴀᴅᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}ada`,
                          },
                          {
                            title: 'ʜɪʀᴜ ɴᴇᴡꜱ 📰',
                            description: '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ ʜɪʀᴜ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️"; // Default Artful Name
...
┕━━━━━━━━━━●►
   ...
   *අඩන්න එපා හලිද profile එක විතරයිනේ ගත්තේ මන් අල ගේනත් දෙන්නම්කො සුදු හලිද 🥺☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️=.owner0705851067*
`;
   ...
   // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗨ʀʟ 𝗖ᴀꜱᴇ
        ...
        case 'upload': {
          ...
          const metaQuote = {
            ...
            message: { contactMessage: { displayName: "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Upload Service\nORG:Catbox/ImgBB\nEND:VCARD` } }
          };
    ...
    // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗚ᴊɪᴅ 𝗖ᴀꜱᴇ
        ...
        case 'grouplist': {
          try {
            ...
            const sanitized = (number || '').replace(/[^0-9]/g, '');
            const cfg = await loadUserConfigFromMongo(sanitized) || {};
            const botName = cfg.botName || BOT_NAME_FANCY || "☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️";
...
`;
    ...
    // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗝ɪᴅ 𝗖ᴀꜱᴇ
        case 'jid': {
          const sanitized = (number || '').replace(/[^0-9]/g, '');
          const cfg = await loadUserConfigFromMongo(sanitized) || {};
          const botName = cfg.botName || '☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️'; // dynamic bot name
...
`☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️  ᴄᴏɴɴᴇᴄᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ❤️\n*• \`ᴠᴇʀꜱɪᴏɴ\` : ᴠ2.0.0*\n*• \`ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛ ɴʙ\` : ${number}*\n*• \`ᴘᴏᴡᴇʀᴇᴅ ʙʏ\` : ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*\n\n*•Hy Hy ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️ වේත ඔයාව සාදරයෙන් පිලිගන්නවා.......🥹❤️‍🩹*\n\n_*ඉතිම් ලස්සන ලමයො ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️  𝗠𝗜𝗡𝗜 𝗕𝗢𝗧 ගැන ඔයාලාට තියේන අදහස් අනිවාරෙන් කියන්න ඔනේ හරිද 🌚💗*_\n\n*🌐 ᴡᴇʙ ꜱɪᴛᴇ :*\n> https://e0b48abf785670f9.app.lowcloud.co`,
                            '> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ☠️𝐍𝐈𝐊𝐈𝐘𝐀 𝐗 𝐌𝐃☠️*',
          );
